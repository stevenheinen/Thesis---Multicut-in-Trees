...
namespace TESTS_MulticutInTrees.ReductionRules
{
    ...
    public class UnitTestOverloadedEdge
    {
        ...
        public void TestConstructor()
        {
            ...
            OverloadedEdge overloadedEdge = new(tree, demandPairs, algorithm, partialSolution, maxSize);
        ...
        public void TestNullParameter()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => { OverloadedEdge oe = new(null, demandPairs, algorithm, partialSolution, maxSize); });
            Assert.ThrowsException<ArgumentNullException>(() => { OverloadedEdge oe = new(tree, null, algorithm, partialSolution, maxSize); });
            Assert.ThrowsException<ArgumentNullException>(() => { OverloadedEdge oe = new(tree, demandPairs, null, partialSolution, maxSize); });
            Assert.ThrowsException<ArgumentNullException>(() => { OverloadedEdge oe = new(tree, demandPairs, algorithm, null, maxSize); });
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => { OverloadedEdge oe = new(tree, demandPairs, algorithm, partialSolution, -56); });
        }
        ...
        public void TestAfterDemandPathChanged1()
        {
            ...
            tree.AddEdges(new List<Edge<Node>>() { edge01, edge12, edge13, edge14, edge35 }, MockCounter);
            tree.UpdateNodeTypes();
            ...
            algorithm.ChangeEndpointOfDemandPair(dp2, node5, node3, MockMeasurements);
