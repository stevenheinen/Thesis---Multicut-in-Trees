    ...
    public class UnitTestBidimensionalDominatingWingspan
    {
        ...
        private static BidimensionalDominatingWingspan GetReductionRuleInAlgorithm(Algorithm algorithm)
        {
            ...
            foreach (ReductionRule rr in algorithm.ReductionRules)
            {
                ...
                if (rr.GetType() == typeof(BidimensionalDominatingWingspan))
                {
                    return (BidimensionalDominatingWingspan)rr;
                }
            }

            throw new Exception($"Could not find a Reduction Rule of type {typeof(BidimensionalDominatingWingspan)} in this algorithm. It has Reduction Rules: {algorithm.ReductionRules.Print()}.");
        }
        ...
        public void TestConstructor()
        {
            ...
            BidimensionalDominatingWingspan bidimensionalDominatingWingspan = new(tree, dps, algorithm, demandPairsPerNode, caterpillarComponentPerNode, partialSolution, maxSolutionSize);
        ...
        public void TestNullParameter()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => new BidimensionalDominatingWingspan(null, demandPairs, algorithm, demandPairsPerNode, caterpillarComponentPerNode, partialSolution, maxSize));
            Assert.ThrowsException<ArgumentNullException>(() => new BidimensionalDominatingWingspan(tree, null, algorithm, demandPairsPerNode, caterpillarComponentPerNode, partialSolution, maxSize));
            Assert.ThrowsException<ArgumentNullException>(() => new BidimensionalDominatingWingspan(tree, demandPairs, null, demandPairsPerNode, caterpillarComponentPerNode, partialSolution, maxSize));
            Assert.ThrowsException<ArgumentNullException>(() => new BidimensionalDominatingWingspan(tree, demandPairs, algorithm, null, caterpillarComponentPerNode, partialSolution, maxSize));
            Assert.ThrowsException<ArgumentNullException>(() => new BidimensionalDominatingWingspan(tree, demandPairs, algorithm, demandPairsPerNode, null, partialSolution, maxSize));
            Assert.ThrowsException<ArgumentNullException>(() => new BidimensionalDominatingWingspan(tree, demandPairs, algorithm, demandPairsPerNode, caterpillarComponentPerNode, null, maxSize));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new BidimensionalDominatingWingspan(tree, demandPairs, algorithm, demandPairsPerNode, caterpillarComponentPerNode, partialSolution, -1));
        }
        ...
        public void TestFirstIterationTrue()
        {
            ...
            DemandPair dp2 = new(2, node1, node5, graph);
            DemandPair dp3 = new(3, node2, node4, graph);
            DemandPair dp4 = new(4, node4, node5, graph);
            CountedCollection<DemandPair> demandPairs = new(new List<DemandPair>() { dp1, dp2, dp3, dp4 }, MockCounter);

            MulticutInstance instance = new(InputTreeType.Fixed, InputDemandPairsType.Fixed, -1, graph, demandPairs, 1, 1);
            BousquetKernelisation algorithm = new(instance);

            BidimensionalDominatingWingspan bidimensionalDominatingWingspan = GetReductionRuleInAlgorithm(algorithm);
        ...
        public void TestAfterDemandPairRemoved()
        {
            ...
            Assert.IsFalse(bidimensionalDominatingWingspan.RunLaterIteration());
        }
        ...
        public void TestAfterDemandPairChanged()
        {
            ...
            DemandPair dp1 = new(1, node1, node4, graph);
            DemandPair dp2 = new(2, node1, node5, graph);
            DemandPair dp3 = new(3, node2, node10, graph);
            DemandPair dp4 = new(4, node4, node5, graph);
            CountedCollection<DemandPair> demandPairs = new(new List<DemandPair>() { dp1, dp2, dp3, dp4 }, MockCounter);
            ...
            algorithm.ChangeEndpointOfDemandPair(dp3, node10, node4, MockMeasurements);
        ...
        public void TestAfterEdgeContraction()
        {
            ...
            graph.AddEdges(new List<Edge<Node>>() { edge01, edge06, edge07, edge12, edge23, edge25, edge34, edge410, edge108, edge109, edge511 }, MockCounter);
            graph.UpdateNodeTypes();

            DemandPair dp1 = new(1, node1, node4, graph);
            DemandPair dp2 = new(2, node1, node11, graph);
            DemandPair dp3 = new(3, node2, node4, graph);
            DemandPair dp4 = new(4, node4, node11, graph);
            CountedCollection<DemandPair> demandPairs = new(new List<DemandPair>() { dp1, dp2, dp3, dp4 }, MockCounter);
            ...
            algorithm.ContractEdge(edge511, MockMeasurements);
