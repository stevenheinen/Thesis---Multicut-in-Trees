...
namespace TESTS_MulticutInTrees.Exceptions
{
    ...
    public class UnitTestAlreadyANeighbourException
    {
        ...
        {
            AlreadyANeighbourException addNeighbourToSelfException = new();
        ...
        {
            AlreadyANeighbourException addNeighbourToSelfException = new("Test message");
            Assert.IsNotNull(addNeighbourToSelfException);
        ...
        {
            Exception inner = new();
            AlreadyANeighbourException addNeighbourToSelfException = new("Test", inner);
            Assert.IsNotNull(addNeighbourToSelfException);
