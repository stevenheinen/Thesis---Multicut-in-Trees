...
namespace TESTS_MulticutInTrees.Exceptions
{
    ...
    public class UnitTestInvalidEdgeException
    {
        ...
        {
            InvalidEdgeException addNeighbourToSelfException = new();
        ...
        {
            InvalidEdgeException addNeighbourToSelfException = new("Test message");
            Assert.IsNotNull(addNeighbourToSelfException);
        ...
        {
            Exception inner = new();
            InvalidEdgeException addNeighbourToSelfException = new("Test", inner);
            Assert.IsNotNull(addNeighbourToSelfException);
