...
namespace TESTS_MulticutInTrees.Experiments
{
    ...
    public class UnitTestExperimentOutputWriter
    {
        ...
        {
            ExperimentOutput output = new ExperimentOutput(1, 1, InputTreeType.Fixed, InputDemandPairsType.Fixed, AlgorithmType.GuoNiedermeierKernelisation, 1, 1, 1, true, 1, 1, new PerformanceMeasurements(nameof(UnitTestExperimentOutputWriter)), new ReadOnlyCollection<PerformanceMeasurements>(new List<PerformanceMeasurements>()));
