...
namespace TESTS_MulticutInTrees.Algorithms
{
    ...
    public class UnitTestBousquetKernelisation
    {
        ...
        public void TestRandomLargerInstance1()
        {
            ...
            Assert.AreEqual(311, result.Item1.NumberOfNodes(MockCounter));
        ...
        public void TestRandomLargerInstance2()
        {
            ...
            Assert.AreEqual(593, result.Item1.NumberOfNodes(MockCounter));
            Assert.AreEqual(19, result.Item2.Count);
            Assert.AreEqual(790, result.Item3.Count);
        }
        ...
        public void TestRandomLargerInstance3()
        {
            ...
            Assert.AreEqual(103, result.Item1.NumberOfNodes(MockCounter));
