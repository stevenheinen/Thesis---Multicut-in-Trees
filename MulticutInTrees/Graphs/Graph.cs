...
namespace MulticutInTrees.Graphs
{
    ...
    /// </summary>
    public class Graph<TNode> : IGraph<TNode> where TNode : INode<TNode>
    {
        /// <summary>
        ...
        internal Graph(IGraph<TNode> interfaceGraph, Counter counter) : this()
        {
#if !EXPERIMENT
...
#endif
            InternalNodes = new CountedCollection<TNode>(interfaceGraph.Nodes(counter), counter);
            InternalEdges = new CountedCollection<(TNode, TNode)>(interfaceGraph.Edges(counter), counter);
        }
        ...
        /// </summary>
        /// <param name="node">The <typeparamref name="TNode"/> for which we want to know if it is part of this <see cref="Graph{N}"/>.</param>
        /// <param name="counter">The <see cref="Counter"/> used for performance measurement.</param>
        ...
        public bool HasEdge(TNode origin, TNode destination, Counter counter, bool directed = false)
        {
#if !EXPERIMENT
        ...
        /// </summary>
        /// <param name="edge">The tuple of two <typeparamref name="TNode"/>s for which we want to know if it is part of this <see cref="Graph{N}"/>.</param>
        /// <param name="counter">The <see cref="Counter"/> used for performance measurement.</param>
        ...
        public bool HasEdge((TNode, TNode) edge, Counter counter, bool directed = false)
        {
        ...
        /// <summary>
        /// Add a new <typeparamref name="TNode"/> <paramref name="node"/> to this <see cref="Graph{N}"/>.
        /// </summary>
        ...
        public void AddNode(TNode node, Counter counter)
        {
#if !EXPERIMENT
        ...
        /// <summary>
        /// Add multiple new <typeparamref name="TNode"/>s to this <see cref="Graph{N}"/>.
        /// </summary>
        /// <inheritdoc/>
        ...
        public void AddEdge(TNode origin, TNode destination, Counter counter, bool directed = false)
        {
#if !EXPERIMENT
...
#endif
            (TNode, TNode) edge1 = (origin, destination);
#if !EXPERIMENT
        ...
        public void AddEdges(IEnumerable<(TNode, TNode)> edges, Counter counter, bool directed = false)
        {
#if !EXPERIMENT
...
#endif
            foreach ((TNode origin, TNode destination) in edges)
            {
        ...
        /// <summary>
        /// Remove an <typeparamref name="TNode"/> from this <see cref="Graph{N}"/>.
        /// </summary>
        /// <inheritdoc/>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="node"/> or <paramref name="counter"/> is <see langword="null"/>.</exception>
        ...
        /// <summary>
        /// Remove multiple <typeparamref name="TNode"/>s from this <see cref="Graph{N}"/>.
        /// </summary>
        /// <inheritdoc/>
        ...
        /// <summary>
        /// Removes all edges connected to a given <typeparamref name="TNode"/> from this <see cref="Graph{N}"/>.
        /// </summary>
        /// <inheritdoc/>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="node"/> or <paramref name="counter"/> is <see langword="null"/>.</exception>
        /// <exception cref="NotInGraphException">Thrown when <paramref name="node"/> is not part of this <see cref="Graph{N}"/>.</exception>
        public void RemoveAllEdgesOfNode(TNode node, Counter counter, bool directed = false)
        {
#if !EXPERIMENT
        ...
        /// <inheritdoc/>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="edges"/> or <paramref name="counter"/> is <see langword="null"/>.</exception>
        public void RemoveEdges(IList<(TNode, TNode)> edges, Counter counter, bool directed = false)
        {
#if !EXPERIMENT
        ...
        public void RemoveEdge(TNode origin, TNode destination, Counter counter, bool directed = false)
        {
#if !EXPERIMENT
...
#endif
            (TNode, TNode) edge1 = (origin, destination);
            (TNode, TNode) edge2 = (destination, origin);
#if !EXPERIMENT
...
#endif
            return DFS.IsAcyclicGraph<Graph<TNode>, TNode>(this, counter);
        }
