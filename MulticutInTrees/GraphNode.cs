...
namespace MulticutInTrees
{
    ...
    /// </summary>
    public class GraphNode : INode<GraphNode>
    {
        /// <summary>
        ...
        public GraphNode(uint id, IEnumerable<GraphNode> neighbours)
        {
            ...
            // If the IEnumerable paramater with neighbours does not exist or is null, treat them as not provided.
        ...
        /// <exception cref="NullReferenceException">Thrown when the parameter <paramref name="neighbour"/> is <see langword="null"/>.</exception>
        ...
        public void AddNeighbour(GraphNode neighbour)
        {
            ...
            {
                throw new NullReferenceException($"Trying to add a child to {this}, but child is null!");
            }
            if (neighbour == this)
            {
                throw new AddNeighbourToSelfException($"Trying to add {neighbour} as a child to itself!");
            }
        ...
        /// <exception cref="NullReferenceException">Thrown when the <see cref="IEnumerable{T}"/> parameter with neighbours is <see langword="null"/>.</exception>
        public void AddNeighbours(IEnumerable<GraphNode> neighbours)
        {
            if (neighbours is null)
            {
                throw new NullReferenceException($"Trying to add a list of children to {this}, but the list is null!");
            }
        ...
        public void RemoveNeighbour(GraphNode neighbour)
        {
            if (neighbour is null)
            {
                throw new NullReferenceException($"Trying to remove a child from {this}, but child is null!");
            }
            if (!InternalUniqueNeighbours.Contains(neighbour))
            {
        ...
        /// <exception cref="NullReferenceException">Thrown when the <see cref="IEnumerable{T}"/> parameter is <see langword="null"/>.</exception>
        public void RemoveNeighbours(IEnumerable<GraphNode> neighbours)
        {
            if (neighbours is null)
            {
                throw new NullReferenceException($"Trying to remove a list of children from {this}, but the list is null!");
            }
        ...
        /// </summary>
        /// <returns>The <see cref="string"/> "Node [ID]", where [ID] is <see cref="ID"/>.</returns>
        ...
        /// <exception cref="NullReferenceException">Thrown when the parameter <paramref name="node"/> is <see langword="null"/>.</exception>
        public bool HasNeighbour(GraphNode node)
        {
            if (node is null)
            {
                throw new NullReferenceException($"Trying to see if {this} has a neighbour, but the neighbour is null!");
            }
        ...
        /// <exception cref="NullReferenceException">Thrown when <paramref name="obj"/> is <see langword="null"/>.</exception>
        ...
        public override bool Equals(object obj)
        {
            if (obj is null)
            {
                throw new NullReferenceException($"Trying to compare {this} to null!");
            }
        ...
        /// <exception cref="NullReferenceException">Thrown when <paramref name="other"/> is <see langword="null"/>.</exception>
        public bool Equals(INode<GraphNode> other)
        {
            if (other is null)
            {
                throw new NullReferenceException($"Trying to compare {this} to null!");
        ...
        /// <exception cref="NullReferenceException">Thrown when <paramref name="lhs"/> or <paramref name="rhs"/> is <see langword="null"/>.</exception>
        public static bool operator ==(GraphNode lhs, GraphNode rhs)
        {
            if (lhs is null)
            {
                throw new NullReferenceException("Left hand side of == operator for GraphNode is null!");
            }
            if (rhs is null)
            {
                throw new NullReferenceException("Right hand side of == operator for GraphNode is null!");
            }
