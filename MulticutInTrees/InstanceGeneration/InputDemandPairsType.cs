...
namespace MulticutInTrees.InstanceGeneration
{
    ...
    public enum InputDemandPairsType
    {
        ...
        FromTreeInstance,
        /// <summary>
        /// The demand pairs are generated by picking a solution of a certain size, and making sure each demand pair goes through exactly one of the edges in the solution.
        /// </summary>
        ThroughKnownSolution,
    }
}
