...
{
    /// <summary>
    /// Class that generates a Degree3 tree, that is, a tree with bounded degree 3.
    /// </summary>
    public static class Degree3TreeGenerator
    {
        /// <summary>
        ...
        public static Graph CreateDegree3Tree(int numberOfNodes)
        {
#if !EXPERIMENT
            if (numberOfNodes < 1)
            {
