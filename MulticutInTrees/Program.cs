    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                //split = "--treeSeed=7811831 --dpSeed=5951100 --repetitions=1 --experiments=1 --algorithm=GuoNiedermeierKernelisation --treeType=Prufer --dpType=Random --nrNodes=256 --nrDPs=896 --maxSolutionSize=0 -v".Split();
                //split = "--treeSeed=7811831 --dpSeed=5951100 --repetitions=1 --experiments=1 --algorithm=ChenKernelisation --treeType=Prufer --dpType=Random --nrNodes=256 --nrDPs=896 --maxSolutionSize=0 -v".Split();
