...
namespace MulticutInTrees.ReductionRules
{
    ...
    public class DominatedPath : ReductionRule
    {
        ...
        public DominatedPath(Tree<TreeNode> tree, List<DemandPair> demandPairs, Algorithm algorithm, Dictionary<(TreeNode, TreeNode), List<DemandPair>> demandPairsPerEdge) : base(tree, demandPairs, algorithm)
        {
