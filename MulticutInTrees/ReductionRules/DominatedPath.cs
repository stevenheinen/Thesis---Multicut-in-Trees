...
namespace MulticutInTrees.ReductionRules
{
    ...
    public class DominatedPath : ReductionRule
    {
        ...
        public DominatedPath(Graph tree, CountedList<DemandPair> demandPairs, Algorithm algorithm, CountedDictionary<Edge<Node>, CountedCollection<DemandPair>> demandPairsPerEdge) : base(tree, demandPairs, algorithm)
        {
#if !EXPERIMENT
